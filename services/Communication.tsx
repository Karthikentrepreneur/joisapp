...
export const Communication: React.FC<CommunicationProps> = ({ role, currentUser, showToast }) => {
  ...
  const loadData = async () => {
    ...
    if (activeTab === 'announcements') {
      const userClassId = currentUser.classAssigned || currentUser.class_assigned || currentUser.childClassId || currentUser.child_class_id || currentUser.classId || currentUser.class_id;
  ...
  return (
    <div className="h-full flex flex-col bg-slate-50">
      ...
      <CreateAnnouncementModal
        ...
        userRole={role}
        userClassId={currentUser.classAssigned || currentUser.class_assigned || currentUser.childClassId || currentUser.child_class_id || currentUser.classId || currentUser.class_id}
