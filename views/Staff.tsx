    ...
    <div className="flex flex-col gap-1 min-w-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 min-w-0 flex-1">
          <p className="text-sm font-semibold text-slate-800 truncate">{displayValue}</p>
          {isSecret && value && (
            <button 
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 no-scrollbar bg-white">
              ...
              <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-6">
                   ...
                   <DetailItem label="Portal Password" value={selectedStaff.password || 'Not Set'} icon={Key} isSecret />
                </div>
              </section>
